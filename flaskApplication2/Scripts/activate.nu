...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Ahmed\PycharmProjects\flaskApplication2'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Ahmed\PycharmProjects\flaskApplication2\Scripts\deactivate.nu'
